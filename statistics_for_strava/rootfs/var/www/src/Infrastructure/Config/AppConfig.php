...
final class AppConfig
{
    ...
    private static function buildConfig(): void
    {
        ...
        if (!$isTest && !is_dir($basePath) && is_dir('/data/config/app')) {
            // Home Assistant add-on fallback when /var/www/config/app is not mounted/symlinked.
            $basePath = '/data/config/app';
        }
